...
import '../../infrastructure/user_hive_sevices.dart';
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        onPressed: () {
                          if (AuthVars.registerformkey.currentState!
                              .validate()) {
                            locator<AuthService>().registeruser().then((value) {
                              if (value == true) {
